...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MetabolomicsTools'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MetabolomicsTools.MetabolomicsToolsImpl import MetabolomicsTools  # noqa @IgnorePep8
impl_MetabolomicsTools = MetabolomicsTools(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MetabolomicsTools'
        ...
        self.rpc_service.add(impl_MetabolomicsTools.get_mona_spectra,
