package us.kbase.metabolomicstools;
...
public class MetabolomicsToolsClient {
     ...
     */
    public MetabolomicsToolsClient(URL url) {
     ...
     * validity.
     */
    public MetabolomicsToolsClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public MetabolomicsToolsClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public MetabolomicsToolsClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("MetabolomicsTools.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
